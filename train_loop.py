...
drugBankBasePath = "/Users/raghav/PycharmProjects/DrugNameRecognition/tagger/data/conll2003/DrugBank/NER/"
medLineBasePath = "/Users/raghav/PycharmProjects/DrugNameRecognition/tagger/data/conll2003/MedLine/NER/"
...
optparser.add_option(
    "-T", "--train", default=drugBankBasePath+"train.txt",
    help="Train set location"
)
optparser.add_option(
    "-d", "--dev", default=drugBankBasePath+"dev.txt",
    help="Dev set location"
)
optparser.add_option(
    "-t", "--test", default=drugBankBasePath+"test.txt",
...
def runModelInLoop(dropout,char_dim,char_lstm_dim,word_dim,word_lstm_dim):
    #results File
    resultsPath = "/Users/raghav/PycharmProjects/DrugNameRecognition/tagger/results/"
                ...
                for x_word_dim in word_dim:
                    for y_word_lstm_dim in word_lstm_dim:
                        for dataset in datasets:
                            ...
                            if(dataset == "DrugBank"):
                                opts.train = drugBankBasePath+"train.txt"
                                opts.dev = drugBankBasePath+ "dev.txt"
                                opts.test = drugBankBasePath+ "test.txt"
                                resultsFile = resultsPath +"drugBankResults.txt"
                                # resultsFile = open(resultsPath, "a")



                            #If dataset is MedLine Assign predefined path
                            if(dataset == "MedLine"):
                                opts.train = medLineBasePath + "train.txt"
                                opts.dev = medLineBasePath + "dev.txt"
                                opts.test = medLineBasePath + "test.txt"
                                resultsFile = resultsPath +"medLineResults.txt"
                                # resultsFile = open(resultsPath, "a")
...
print "Running the model for DrugBank and MedLine Data -------"
